...
Примеры когда уже понятно и уточнять НЕ надо:
- «как зарегистрировать новый ручной отчёт» → тип запроса=регистрация, тип=ручной
- «как автоматизировать отчёт» → тип запроса=автоматизация
- «как актуализировать существующий отчёт» → тип=актуализация

Примеры когда надо уточнить — тип НЕ указан:
- «как создать запрос» → непонятно какой
- «что нужно сделать с отчётом» → непонятно
...
- Тип уже известен из контекста диалога
