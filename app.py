...
- `text` — полное описание шага. ОБЯЗАТЕЛЬНО каждое действие на отдельной строке через \n. Формат: "1. Действие\n2. Следующее действие\nПримечание: ...\nРезультат: ..."
- Никогда не пиши все действия в одну строку через запятую или точку с запятой
...
def render_step_card_html(card, docs=None):
    ...
    # Рендер текста — разбиваем по \n и по паттерну "N. "
    import re
    # Сначала вставляем \n перед каждым "N. " чтобы разбить слипшийся список
