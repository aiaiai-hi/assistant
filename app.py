...
|||STEP_CARD|||
{"step": N, "total": M, "title": "название шага", "role": "читаемое название роли на русском", "text": "подробное описание шага из контекста дословно"}
|||END_CARD|||
...
<div class="sc-card">
  <div class="sc-header">
    <div class="sc-counter">ШАГ {step} ИЗ {total}</div>
